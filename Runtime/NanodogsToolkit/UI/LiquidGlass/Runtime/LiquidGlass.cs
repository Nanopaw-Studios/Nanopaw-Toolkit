...
namespace NanodogsToolkit.UI.LiquidGlass
{
    ...
    public class LiquidGlass : MonoBehaviour
    {
        ...
        [SerializeField, Range(0f, 2f), Tooltip("Blur mix amount: 0 is clear glass, 1 is standard screen blur, and >1 adds boosted diffusion.")] private float m_BlurAmount = 1.0f;
        ...
        public float BlurAmount { get => m_BlurAmount; set { m_BlurAmount = Mathf.Clamp(value, 0f, 2f); Refresh(); } }
